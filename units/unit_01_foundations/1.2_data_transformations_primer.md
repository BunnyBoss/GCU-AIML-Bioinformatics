...
### Compressing Runaway Scales: The Wealth Analogy
...
### Right-Skewed Count Dynamics in RNA-Seq
...
### Pseudocounts and the Base-2 Biological Convention
...
### Relative Position vs. Absolute Magnitude: The Cohort Height Analogy
...
### Balancing Housekeeping vs. Regulatory Biomarkers
...
### Centering, Unit Variance, and Properties
...
### Fixed Maximums and Percentages: The Exam Score Analogy
...
### Bounded Optical Dynamic Range in Digital Pathology
...
### Bounded Scales and Outlier Sensitivity
...
### Resisting Severe Skew: The Grade Typo Analogy
...
### Acute Inflammation Spikes in Clinical Blood Panels (CRP)
...
### Order Statistics: Medians and Interquartile Ranges
...
```mermaid
graph TD
    Data([Raw Biological Data]) --> Q1{Does downstream<br>method need normality?}
    
    Q1 -- Yes --> T1[Transform shape<br>e.g., Log2 on RNA-seq reads]
    Q1 -- No --> Q2
    T1 --> Q2{Does model<br>need scaling?}
    
    Q2 -- No --> S0[Don't scale<br>e.g., Random Forest, XGBoost]
    Q2 -- Yes --> Q3{What matters?}
    
    Q3 -- Outliers are a concern --> S1[RobustScaler<br>Median & IQR<br>e.g., k-NN, Linear Classifiers]
    Q3 -- No major outliers --> S2[StandardScaler<br>Z-score: Mean & Std<br>e.g., PCA, SVM, Logistic Regression]
    Q3 -- Specifically need bounded range? --> S3[MinMaxScaler<br>Bounded interval 0, 1<br>e.g., Neural Nets, Digital Pathology]
```
